...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes=15, depth_mult=3, expansion=1/4, act="silu", dropout=0.2):
        ...
        self.freq_fuse = CrossSightFreqInteract(64)
        # self.cfe1 = MultiScaleSightFeatureEnhance(256)
        self.cfe2 = MultiScaleSightFeatureEnhance(512, 1024)
        self.cfe3 = MultiScaleSightFeatureEnhance(1024, 2048)
        self.cfe4 = MultiScaleSightFeatureEnhance(2048)

        output_dim = output_channels[3]
        depth_mult = 1
        self.ol_sd_fuse = MutilSightFuseModule(output_channels[3]*2, output_dim, depth_mult=depth_mult)
        # output_dim = 4096
        # print(output_dim)
    ...
    def forward(self, image_ol, image_sd):
        ...
        bf_ol, bf_sd = self.freq_fuse(bf_ol, bf_sd)
        ...
        f_l3_ol, f_l3_sd, s_ol, s_sd = self.cfe3(f_l3_ol+f_l3_ol*s_ol, f_l3_sd+f_l3_sd*s_sd)

        f_l4_ol = self.layer4(f_l3_ol)
        f_l4_sd = self.layer4(f_l3_sd)
        f_l4_ol, f_l4_sd, s_ol, s_sd = self.cfe4(f_l4_ol+f_l4_ol*s_ol, f_l4_sd+f_l4_sd*s_sd)
