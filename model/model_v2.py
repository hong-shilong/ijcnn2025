...
class MSCFE(nn.Module):
    def __init__(self, ch_in, ch_next=None, num_heads=4):
...
class MyModel(nn.Module):
    ...
    def __init__(self, num_classes=15, depth_mult=3, expansion=1/4, act="silu", dropout=0.2):
        ...
        self.fdim = FDIM(256)
        self.cfe1 = MSCFE(256, 512)
        self.cfe2 = MSCFE(512, 1024)
        self.cfe3 = MSCFE(1024, 2048)
        self.cfe4 = MSCFE(2048)

        output_dim = output_channels[3]
        self.ol_sd_fuse = CAFM(output_channels[3]*2, output_dim, depth_mult=depth_mult)
        # output_dim = 4096
        # print(output_dim)
    ...
    def forward(self, image_ol, image_sd):
        ...
        # f_l1_ol, f_l1_sd, s_ol, s_sd = self.cfe1(f_l1_ol, f_l1_sd)
